...
> Cuando el factor de potencia es bajo ($\varphi>60^\circ$), el ángulo $30^\circ+\varphi$ supera $90^\circ$ y **$W_1$ se vuelve negativo**: hay que invertir su conexión y **restar** su lectura. Si $\varphi=60^\circ$ ($\cos\varphi=0{,}5$), un vatímetro marca **cero**. La suma, en cambio, siempre da la $P$ correcta.

> [!algoritmo] Aplicar el método
> **Paso 1 — Conectar.** Bobinas de corriente en dos líneas; las de tensión, a la tercera. **Paso 2 — Leer** $W_1$ y $W_2$ (anotar signos). **Paso 3 — Potencia activa:** $P=W_1+W_2$. **Paso 4 — Reactiva y FP:** $Q=\sqrt3(W_2-W_1)$ y $\tan\varphi=\sqrt3(W_2-W_1)/(W_1+W_2)$.
...
> [!referencia]
> Fraile Mora, cap. 3, §3.8. Potencia: [[Potencia en Sistemas Balanceados]]. Factor de potencia: [[Factor de Potencia]] y [[Correccion FP Trifasico]].
