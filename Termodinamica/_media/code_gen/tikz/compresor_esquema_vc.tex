...
\begin{tikzpicture}[line width=1pt,>={Latex[length=2.6mm]}]
  \fill[blue!7] (0,0.3)--(0,2.7)--(4,2)--(4,1)--cycle;
  \draw[line width=1.2pt] (0,0.3)--(0,2.7)--(4,2)--(4,1)--cycle;
  \node at (2,1.5){\small COMPRESOR};
  ...
  \draw[line width=1.3pt] (2,0.55)--(2,-0.45);
  \fill[black!16] (1.65,-0.45) rectangle (2.35,-0.75);
  \draw[<-,red!65!black,line width=1.3pt] (2.35,-0.6)--(3.7,-0.6) node[right]{\small $\dot W_{\text{eje}}<0$ (entra)};
  \node at (2,-1.5){\small $\dot W = \dot m\,(h_2-h_1)$};
\end{tikzpicture}
\end{document}
