...
> [!solucion]
> **Entrada** ($4{,}4$ MPa, $385\,^\circ$C, interpolado): $h_1\approx3169$ kJ/kg, $s_1\approx6{,}663$ kJ/kg·K. **Salida real** (vapor saturado a $105$ kPa): $h_2\approx2677$ kJ/kg. **Salida isentrópica** ($s_{2s}=s_1=6{,}663$ a $105$ kPa, bifásica): $x_{2s}=\dfrac{6{,}663-1{,}303}{6{,}057}=0{,}885$, $h_{2s}=417{,}5+0{,}885(2258)=2416$ kJ/kg.
