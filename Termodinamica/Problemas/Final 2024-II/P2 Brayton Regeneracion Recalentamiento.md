...
>
> **Compresor** $1\to2$: $T_{2s}=290\,(9)^{0{,}2857}=543{,}3$ K; real $T_{2r}=290+\dfrac{543{,}3-290}{0{,}9}=571{,}4$ K. **Turbina AP** $3\to4$: $T_{4s}=1200\,(1/3)^{0{,}2857}=876{,}7$ K; real $T_{4r}=1200-0{,}9(1200-876{,}7)=909{,}0$ K. **Turbina BP** $5\to6$: por simetría ($r_p=3$, $T_5=1200$): $T_{6r}=909{,}0$ K.
