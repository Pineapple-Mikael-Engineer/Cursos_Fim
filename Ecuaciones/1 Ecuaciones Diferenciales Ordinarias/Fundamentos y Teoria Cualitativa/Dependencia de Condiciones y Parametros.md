...
> cota: una variación $|\lambda_1-\lambda_2|$ se propaga, también vía [[Desigualdad de Gronwall |
> Gronwall]], como $|y(x;\lambda_1)-y(x;\lambda_2)|\le C\,|\lambda_1-\lambda_2|\,e^{L|x-x_0|}$. Datos
