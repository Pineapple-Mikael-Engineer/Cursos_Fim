...
> [!info]
> Primer tipo del [[Metodos de Primer Orden/index| catálogo de primer orden]] (libro, cap. 1.1.2). Las
...
> una integral. Apóyate en el [[Campo de Direcciones e Isoclinas| campo de direcciones]]
...
> [[Existencia y Unicidad Picard| teorema de la función implícita]],
...
> [[Teorema de Peano| Peano]]), porque $f=xy^{1/2}$ no es
> [[Existencia y Unicidad Picard| Lipschitz]] en $y=0$.
